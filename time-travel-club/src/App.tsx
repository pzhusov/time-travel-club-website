...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#ededed] cursor-none">
      ...
      {/* Mentoring 8888 Section */}
      <section id="mentoring" className="section-padding relative bg-[#0a0a0a]">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <TextReveal>
                <div className="inline-flex items-center gap-2 px-4 py-2 glass rounded-full mb-6">
                  ...
                  <span className="text-xs text-[#888888] uppercase tracking-wider">Exclusive Program</span>
                </div>
              </TextReveal>

              <TextReveal delay={200}>
                <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                  Mentoring <span className="gradient-text">8888</span>
                </h2>
              </TextReveal>
              ...
              <TextReveal delay={400}>
                <div className="space-y-6 text-[#888888] leading-relaxed">
                  <p className="text-lg">
                    Beyond the public forums and the noise of social media, there is a private space where a skilled group of traders is putting theory into practice.
                  </p>
                  <p>
                    This is a closed, results-driven ecosystem for individuals committed to a professional trading process. We focus on building sustainable skills, not chasing short-term hype.
                  </p>
                </div>
              </TextReveal>
              ...
              <TextReveal delay={600}>
                <div className="mt-10">
                  <a
                    href="mailto:info@mentoring8888.com"
                    className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#D4AF37] to-[#F4E4BC] text-[#050505] font-medium rounded-lg hover:opacity-90 transition-all"
                  >
                    Apply Now
              ...
              <TextReveal delay={800}>
                <div className="grid grid-cols-2 gap-6 mt-12">
                  {[
                    { icon: TrendingUp, title: 'Professional Trading', desc: 'Results-driven strategies' },
                    { icon: Users, title: 'Private Community', desc: 'Exclusive member access' },
                    { icon: Lock, title: 'Secure Platform', desc: 'Protected environment' },
                    { icon: Star, title: 'Expert Mentors', desc: 'Industry professionals' }
                  ].map((feature, index) => (
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-medium text-[#ededed]">{feature.title}</div>
                        <div className="text-xs text-[#888888]">{feature.desc}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="relative">
              <TextReveal delay={300}>
                <div className="relative">
                  <div className="aspect-square rounded-3xl glassStrong overflow-hidden glow-gold group">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/10 via-transparent to-transparent" />
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F4E4BC] flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                          <TrendingUp className="w-16 h-16 text-[#050505]" />
                        </div>
                        <div className="text-3xl font-bold mb-2">Mentoring 8888</div>
                        <div className="text-[#888888]">Private Trading Community</div>
                      </div>
                    </div>
                    {/* Corner accents */}
                    <div className="absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-[#D4AF37]/30" />
                  ...
                  <div className="absolute -bottom-6 -left-6 glassStrong px-8 py-5 rounded-2xl glow-gold animate-float">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-xs text-[#888888] uppercase tracking-wider">Access</div>
                        <div className="text-xl font-bold">By Application</div>
                      </div>
                    </div>
                  </div>
